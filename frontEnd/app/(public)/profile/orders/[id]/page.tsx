          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm">
              <div className="flex flex-wrap justify-between items-start gap-4 mb-8">
                ...
                <div className={`px-4 py-2 rounded-2xl border font-black text-xs uppercase tracking-widest flex items-center gap-2 ${order.isDelivered ? 'bg-emerald-50 border-emerald-100 text-emerald-600' : 'bg-amber-50 border-amber-100 text-amber-600'
                  }`}>
                  {order.isDelivered ? <CheckCircle2 size={16} /> : <Clock size={16} />}
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm">
              ...
              <div className="space-y-6 relative before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-[2px] before:bg-slate-100">
                <div className="relative pl-8">
                  {/* <div className={`absolute left-0 top-1 h-6 w-6 rounded-full border-4 border-white shadow-sm z-10 ${order.isDelivered ? 'bg-emerald-500' : 'bg-slate-200'}`} /> */}
                  <p className="font-bold text-slate-900">Order Delivered</p>
                  <p className="text-sm text-slate-500">
                    {order.deliveredAt ? new Date(order.deliveredAt).toLocaleString() : 'Not yet delivered'}
                  </p>
                </div>
                <div className="relative pl-8">
